...
| C-NAM-004 | Use Named Constants Instead of Inline Magic Numbers | Required |
...
| C-MAC-004 | Do Not Create Abstraction Layers Over Zephyr APIs | Critical |
...
- C-MAC-001, C-MAC-003, C-MAC-004
- C-SEC-001, C-SEC-002, C-SEC-003, C-SEC-004
- C-INT-001, C-INT-002, C-INT-003
- C-ARR-001, C-STR-001, C-STR-002, C-DT-002

### Required Rules (27 total)

- C-NAM-001, C-NAM-002, C-NAM-004, C-TYP-002, C-TYP-003, C-CMT-002
- C-MEM-004, C-MEM-005, C-MEM-007
