...
| [Macros](rules/macros.md) | C-MAC-* | Parenthesization, inline functions, no abstraction layers |
...
Use Zephyr APIs directly. No custom macros wrapping kernel primitives.

```c
/* Correct - inline assertion for return value check */
...
| C-NAM-004 | Use Named Constants Instead of Magic Numbers | Required |
...
| C-MEM-007 | Avoid Extern Declarations for Internal Zephyr Symbols | Required |
...
| C-MAC-004 | No Abstraction Layers Over Zephyr APIs | Critical |
